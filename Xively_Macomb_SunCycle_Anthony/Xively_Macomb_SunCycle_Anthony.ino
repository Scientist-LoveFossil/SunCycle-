...
#define relayleft          27 //Blue from photosensor cable  --blacks are gnd
...
////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //if (SolarTracker(counter) < 4999) {  // a counter within solartracker will be able to spit out its info to the main loop,
    for (int x = 0; x < 15000; x++) {    // and we use either the 18sec delay of counter in the solar function,
       delay(1);                         // or a 15 sec delay (x) between calls here -- KC.
    
  // Serial.print("     x =    ");
  // Serial.println(x);
  
  } //Serial.println("     delayed 15 seconds   ");    } else { 
//   return; }  //  Not sure what this is returning from. It will end the loop if this is the main program?
}
//-------------------------------------------------------------------------------------------------------
